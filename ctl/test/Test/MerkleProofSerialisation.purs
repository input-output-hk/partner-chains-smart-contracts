...
-- | `test` follows the integration tests described in #249. We have a test
-- | cases for:
...
test = do
  ...
  Monad.void do
    ...
    -- Plutus data test
    Console.info
      "Testing 1. Merkle Proof Serialization integration plutus data..."
    Test.Utils.assertBy eq expectedPlutusData $ PlutusData.toData testCase
    Console.info
      "Testing 1. Merkle Proof Serialization integration plutus data succeeded!"

    -- Cbor serialisation test
    Console.info
      "Testing 1. Merkle Proof Serialization integration cbor of plutus data..."
    let
    ...
    Test.Utils.assertBy eq (Just expectedCbor)
      $ Utils.SerialiseData.serialiseData
      $ PlutusData.toData testCase
    Console.info
      "Testing 1. Merkle Proof Serialization integration cbor of plutus data succeeded!"
  ...
  void do
    ...
    Test.Utils.assertBy eq (Just expectedCbor)
      ...
      $ PlutusData.toData testCase
    Console.info
      "Testing 2. Merkle Proof Serialization integration cbor of plutus data succeeded!"
