...
\special{background White} % give a white background (only worked for dvi --> svg which is no longer used)
\pagecolor{white} % give a white background (only worked for dvi --> svg which is no longer used)
