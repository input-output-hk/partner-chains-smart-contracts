% Compilation to svg
% > latexmk ./StateMachineWorkflow.tex
% > dvisvgm ./StateMachineWorkflow.dvi --stdout > ./StateMachineWorkflow.svg  # converts `dvi` to `svg`
% > # And now, cleaning up the extra files..
% > latexmk -c ./StateMachineWorkflow.tex && rm ./StateMachineWorkflow.dvi
% or as one command
% > latexmk ./StateMachineWorkflow.tex && dvisvgm ./StateMachineWorkflow.dvi --stdout > ./StateMachineWorkflow.svg && latexmk -c ./StateMachineWorkflow.tex && rm ./StateMachineWorkflow.dvi
...
\tikzset{
    ...
    node distance=20cm, % specifies the minimum distance between two nodes. Change if necessary.
}
