...
aggregateKeys :: [SidechainPubKey] -> LedgerBytes
aggregateKeys = LedgerBytes . Builtins.blake2b_256 . mconcat . map (getLedgerBytes . getSidechainPubKey)
...
aggregateCheck :: [SidechainPubKey] -> LedgerBytes -> Bool
