...
getVersionedScriptRefUtxo sp versionOracle = do
  ...
  txInput /\ txOutput ←
    liftContractM
      "Could not find unspent output with correct script ref locked at version oracle validator address"
