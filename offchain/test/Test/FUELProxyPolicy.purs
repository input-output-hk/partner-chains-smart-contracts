...
testScenarioSuccess =
  Mote.Monad.test "Multiple minting and burning, updating policies in between"
    ...
    $ \alice → Wallet.withKeyWallet alice do
        let
          loc = { mod: "Test.FUELProxyPolicy", fun: "testScenarioSuccess" }
        ...
        void $ Versioning.insertVersion sidechainParams 2
  ...
  Mote.Monad.test
    ...
    $ \alice →
        Wallet.withKeyWallet alice do
          let
            loc = { mod: "Test.FUELProxyPolicy", fun: "testScenarioFailure" }
          ...
          void $ Versioning.updateVersion sidechainParams 1 2
