...
testScenarioSuccess =
  Mote.Monad.test "Multiple minting and burning, updating policies in between"
    ...
    $ \alice → withUnliftApp "Test.FUELProxyPolicy.testScenarioSuccess"
...
testScenarioSuccess2 =
  Mote.Monad.test "Minting FUELProxy, and then minting again"
    $ Test.TestnetTest.mkTestnetConfigTest
        [ BigNum.fromInt 150_000_000, BigNum.fromInt 150_000_000 ]
    $ \alice → withUnliftApp "Test.FUELProxyPolicy.testScenarioSuccess2"
        (Wallet.withKeyWallet alice)
        do
...
testScenarioFailure =
  Mote.Monad.test
    ...
    $ Test.TestnetTest.mkTestnetConfigTest
        [ BigNum.fromInt 150_000_000, BigNum.fromInt 150_000_000 ]
    $ \alice →
        withUnliftApp "Test.FUELProxyPolicy.testScenarioFailure"
          (Wallet.withKeyWallet alice)
          do
