...
import Plutus.Script.Utils.V2.Scripts (MintingPolicy , scriptCurrencySymbol , mkUntypedMintingPolicy)
...
import TrustlessSidechain.OnChain.Types (MerkleTreeEntry (mteHash), SignedMerkleRoot (SignedMerkleRoot, committeePubKeys, merkleRoot, signatures, threshold) , UpdateCommitteeHashDatum (committeeHash))
...
mintingPolicy param = mkMintingPolicyScript
